...
<div class="d-flex flex-column justify-content-center align-items-center my-5">
    ...
    <form class="w-50" method="POST" action="./process_cv_submission.php" enctype="multipart/form-data">
        ...
        <div class="cv-info-3">
            ...
            <div class="d-flex justify-content-end">
                <button type="button" id="eduBtn" class="btn btn-primary">Add Education</button>
            </div>
        </div>
        ...
        <div class="cv-info-4">
            ...
            <div class="d-flex justify-content-end">
                <button type="button" id="workingBtn" class="btn btn-primary">Add Working Experience</button>
            </div>
        </div>
